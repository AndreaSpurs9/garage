...
import it.corso.model.Auto;
import it.corso.model.Furgone;
import it.corso.model.Moto;
import it.corso.model.Veicolo;
...
public class Garage {
	...
	private static ArrayList<Veicolo> garage;
	...
	private static void liberaPosto() {
		...
		if (!garage.isEmpty()) {
			...
			System.out.println("***Il garage Ë vuoto***");
		}
	}
